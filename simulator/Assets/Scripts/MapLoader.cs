    ...
    */
    ...
    private void GenerateDefaultMapConfigFile(string filename, bool prettyPrint = true) {
        ...
        mapConfig.SymbolToPrefabMapping = new Dictionary<string, SymbolPrefabPair> {
            ...
            { "B", new SymbolPrefabPair { symbol = "B", prefabName = "Tree 1" } },
            { "C", new SymbolPrefabPair { symbol = "C", prefabName = "Tree1.5" } },
            { "D", new SymbolPrefabPair { symbol = "D", prefabName = "Tree 2" } },
            { "E", new SymbolPrefabPair { symbol = "E", prefabName = "Tree 3" } },
            { "G", new SymbolPrefabPair { symbol = "G", prefabName = "Tree 4" } },
            { "H", new SymbolPrefabPair { symbol = "H", prefabName = "Tree 5" } },
            { "I", new SymbolPrefabPair { symbol = "I", prefabName = "Tree 6" } },
            { "J", new SymbolPrefabPair { symbol = "J", prefabName = "Tree 7" } },
